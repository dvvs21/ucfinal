...
class instrutor(models.Model):
    ...
    rg = models.IntegerField(max_length=15, help_text="Informe o RG do Instrutor (apenas números)")
    ...
    telefone = models.IntegerField(max_length=9, help_text="Informe o Telefone do Instrutor (apenas números)")
